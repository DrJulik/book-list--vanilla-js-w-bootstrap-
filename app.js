...
class UI {
  addBookToList(book) {
    ...
    <td><a href="https://www.goodreads.com/book/isbn/${
      book.isbn
    }" target="_blank"><img src="https://s.gr-assets.com/assets/icons/goodreads_icon_32x32-6c9373254f526f7fdf2980162991a2b3.png"></img><a></td>
...
// search the json and filter through
const title = document.getElementById('title');
const matchList = document.getElementById('titles');
title.addEventListener('input', () => searchBooks(title.value));
